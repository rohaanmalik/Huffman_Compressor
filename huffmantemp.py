...
def huffman_tree(freq_dict):
    ...
    >>> t == HuffmanNode(None, HuffmanNode(0, None, None), HuffmanNode(1, None, None))
    True
    """
    ...
    #     first = data.pop(0)
    #     second = data.pop(0)
    #     sum_hf = first[1] + second[1]
    #     hnode = HuffmanNode(None, HuffmanNode(first[0]), HuffmanNode(second[0]))
    #     data.insert(0,(None, sum_hf))
    # return hnode
...
# print(get_codes(HuffmanNode(None, HuffmanNode(6, None, None), HuffmanNode(None, HuffmanNode(None, HuffmanNode(3, None, None), HuffmanNode(None, HuffmanNode(1, None, None), HuffmanNode(2, None, None))), HuffmanNode(None, HuffmanNode(4, None, None), HuffmanNode(5, None, None))))))
# pre_orderhf(HuffmanNode(None, HuffmanNode(None, HuffmanNode(None, HuffmanNode(None, HuffmanNode(None, HuffmanNode(1, None, None), HuffmanNode(2, None, None)), HuffmanNode(3, None, None)), HuffmanNode(None, HuffmanNode(4, None, None), HuffmanNode(5, None, None)), None), HuffmanNode(6, None, None))))
# pre_orderhf(HuffmanNode(None, HuffmanNode(None, HuffmanNode(3, None, None), HuffmanNode(5, None, None)), HuffmanNode(None, HuffmanNode(2, None, None), HuffmanNode(6, None, None))))
# pre_orderhf(HuffmanNode(None, HuffmanNode(None, HuffmanNode(None, HuffmanNode(None, HuffmanNode(None, HuffmanNode(1, None, None),
#                                                                                                 HuffmanNode(2, None, None))), HuffmanNode(3, None, None)),
#                                           HuffmanNode(None, HuffmanNode(4, None, None),HuffmanNode(5, None, None))), HuffmanNode(6, None, None)))
# print(huffman_tree({1: 5, 2: 7, 3: 10, 4: 15, 5: 20, 6: 45}))
...
def number_nodes(tree):
    ...
    >>> tree = HuffmanNode(None, HuffmanNode(0, None, None), HuffmanNode(1, None, None))
    >>> number_nodes(tree)
    >>> tree.number
    0
    """
...
def postorder(tree, count):
    ...
    >>> t = HuffmanNode(None, HuffmanNode(6, None, None), HuffmanNode(None, HuffmanNode(None, HuffmanNode(3, None, None), HuffmanNode(None, HuffmanNode(1, None,
    None), HuffmanNode(2, None, None))), HuffmanNode(None, HuffmanNode(4, None, None), HuffmanNode(5, None, None))))
    >>> t = HuffmanNode(None, HuffmanNode(0, None, None), HuffmanNode(1, None, None))
    >>> postorder(t)
    >>> t.number
    >>> 0
...
# postorder(HuffmanNode(None, HuffmanNode(6, None, None),
#                               HuffmanNode(None, HuffmanNode(None,
#                                                             HuffmanNode(3, None,
#                                                                         None),
#                                                             HuffmanNode(None,
#                                                                         HuffmanNode(
...
def avg_length(tree, freq_dict):
    ...
    assert sum_freq != 0
    total_chars = 0
    if len(all_codes) > 0: # To check if dictionary is empty
        for key in all_codes: # Multipliyng length of codes by frequency to get toal number of chars
...
# print(codes)
# compress = generate_compressed(text, codes)
# print(compress)
# # print([byte_to_bits(byte) for byte in compress])
...
def generate_tree_general(node_lst, root_index):
    ...
    >>> lst2 = [ReadNode(1, 1, 1, 3), ReadNode(0, 10, 1, 2), ReadNode(0, 5, 0, 4), ReadNode(0, 15, 0, 7)]
    >>> generate_tree_general(lst2, 0)
    HuffmanNode(None, HuffmanNode(None, HuffmanNode(10, None, None), HuffmanNode(None, HuffmanNode(5, None, None), HuffmanNode(4, None, None))), HuffmanNode(None, HuffmanNode(15, None, None), HuffmanNode(7, None, None)))
    ...
    >>> lst4 = [ReadNode(1, 1, 1, 3), ReadNode(0, 3, 1, 2), ReadNode(0, 7, 0, 8), ReadNode(0, 5, 0, 6)]
    >>> generate_tree_general(lst4, 0)
    HuffmanNode(None, HuffmanNode(None, HuffmanNode(3, None, None), HuffmanNode(None, HuffmanNode(7, None, None), HuffmanNode(8, None, None))), HuffmanNode(None, HuffmanNode(5, None, None), HuffmanNode(6, None, None)))
    >>> lst5 = [ReadNode(1, 3, 1, 1), ReadNode(1, 2, 0, 3), ReadNode(0, 7, 0, 8), ReadNode(0, 5, 0, 6)]
    >>> generate_tree_general(lst5, 0)
    HuffmanNode(None, HuffmanNode(None, HuffmanNode(5, None, None), HuffmanNode(6, None, None)), HuffmanNode(None, HuffmanNode(None, HuffmanNode(7, None, None), HuffmanNode(8, None, None)), HuffmanNode(3, None, None)))
    >>> lst6 = [ReadNode(1, 1, 1, 4), ReadNode(1, 2, 1, 3), ReadNode(0, 1, 0, 2), ReadNode(0, 3, 0, 4), ReadNode(0, 5, 0, 6)]
    >>> generate_tree_general(lst6, 0)
    HuffmanNode(None, HuffmanNode(None, HuffmanNode(None, HuffmanNode(1, None, None), HuffmanNode(2, None, None)), HuffmanNode(None, HuffmanNode(3, None, None), HuffmanNode(4, None, None))), HuffmanNode(None, HuffmanNode(5, None, None), HuffmanNode(6, None, None)))
    """
    return function1(HuffmanNode(None, HuffmanNode(None), HuffmanNode(None)), node_lst, node_lst[root_index])


def function1(node, node_lst, root):
#    (huffman_node(none),lst,root)
    ...
    if root.l_type == 1:
        ...
        function1(node.left, node_lst, node_left)
    if root.r_type == 1:
        node_right = node_lst[root.r_data]
        function1(node.right, node_lst, node_right)
    return node
...
def generate_tree_postorder(node_lst, root_index):
    ...
    HuffmanNode(None, HuffmanNode(None, HuffmanNode(1, None, None), HuffmanNode(2, None, None)), HuffmanNode(None, HuffmanNode(3, None, None), HuffmanNode(4, None, None)))
    >>> lst2 = [ReadNode(0,2,0,3),ReadNode(0,1,1,7), ReadNode(0,4,0,5),ReadNode(1,7,1,8)]
    ...
    for node in node_lst:
        if node.l_type == 0:
            leafs.append([node.l_data, node.r_data])
    # print(leafs)

    members = []
    for leaf_pair in leafs:
        members.append(HuffmanNode(None, HuffmanNode(leaf_pair[0]),
                                   HuffmanNode(leaf_pair[1])))

    # print(members)
    while len(members) > 1:
        # print(int(len(members) / 2))
        next_level = []
        for i in range(0, int(len(members) / 2)):
            j = i + 1
            left = members[2 * j - 2]
            right = members[2 * j - 1]
            next_level.append(HuffmanNode(None, left, right))
        members = next_level.copy()
...
#
# lst2 = [ReadNode(0,1,0,2),ReadNode(1,5,0,3), ReadNode(0,4,0,5),ReadNode(1,7,1,8)]
...
def generate_uncompressed(tree, text, size):
    ...
    @rtype: bytes
    >>> t = HuffmanNode(None, HuffmanNode(None, HuffmanNode(3), HuffmanNode(None, HuffmanNode(1), HuffmanNode(4))), HuffmanNode(None, HuffmanNode(2), HuffmanNode(5)))
    >>> text = bytes([216, 0])
    >>> size = 4
    >>> a =  bytes([5, 4, 3, 3])
...
#
# tree = HuffmanNode(None, HuffmanNode(66, None, None), HuffmanNode(None, HuffmanNode(65, None, None), HuffmanNode(67, None, None)))
# text = b'\x98'
...
def improve_tree(tree, freq_dict):
    ...
    >>> tree2 = HuffmanNode(None, HuffmanNode(None, HuffmanNode(100),   HuffmanNode(None, HuffmanNode(98), HuffmanNode(105))), HuffmanNode(None, HuffmanNode(103), HuffmanNode(101)))
